...
Sprite do mestre zen de autoria própria. As imagens dos apoios, dos drones e do fundo foram todas obtidas da Internet (com algumas alterações para adequá-las ao projeto). Música de fundo é "CIRKLON3", do artista Aphex Twin. Efeito sonoro do game over é do jogo Street Fighter II, e o efeito sonoro do drone foi obtido da Internet. A fonte bitmap é Pixelta, de autoria do grupo Blankids.