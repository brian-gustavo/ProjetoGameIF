...
Sprite do mestre zen de autoria própria. O sprite dos apoios, a imagem de fundo e a imagem dos drones foram todos obtidos da Internet (com algumas alterações para adequá-las ao projeto). Música de fundo é "CIRKLON3", do artista Aphex Twin.