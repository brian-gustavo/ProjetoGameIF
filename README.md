...
Sprite do mestre zen de autoria própria. As imagens dos apoios, dos drones e do fundo foram todas obtidas da Internet (com algumas alterações para adequá-las ao projeto). Música de fundo é "CIRKLON3", do artista Aphex Twin.