...
export default class PlayScene extends Phaser.Scene {
    ...
    triggerGameOver() {
        ...
        const btnMenu = this.add.text(400, 380, 'Voltar ao menu', {
            fontSize: '42px', fill: '#fff', stroke: '#000', strokeThickness: 3, fontFamily: 'pixelta'
        }).setOrigin(0.6).setInteractive({ useHandCursor: true });

        btnMenu.on('pointerover', () => btnMenu.setStyle({ fill: '#ff0' }));
